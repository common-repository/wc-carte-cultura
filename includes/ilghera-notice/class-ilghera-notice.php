...
if ( ! class_exists( 'Ilghera_Notice' ) ) {
    ...
    class Ilghera_Notice {
        ...
        public function the_notice( $message, $renew = false ) {
            ...
            $button_text = $renew ? __( 'Aggiorna ora', $this->get_text_domain() ) : __( 'Ottieni una licenza', $this->get_text_domain() );
        ...
        public function expired_license() {
            ...
            $message = wp_kses_post(
                __( 'La licenza è <u>scaduta</u> e non sei in grado di ricevere aggiornamenti.', $this->get_text_domain() )
            );
        ...
        public function bad_license() {
            ...
            $message = wp_kses_post(
                __( 'Sembra che la licenza <u>non sia valida</u> e non sei in grado di ricevere aggiornamenti.', $this->get_text_domain() )
            );
        ...
        public function no_license() {
            ...
            $message = wp_kses_post(
                __( 'Non hai impostato una licenza e non sei in grado di ricevere aggiornamenti.', $this->get_text_domain() )
            );
